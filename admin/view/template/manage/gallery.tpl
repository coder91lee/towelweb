        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left " width = "30%">App</td>
              <td class="left" width = "30%">Ảnh</td>
              <td class="right"><?php echo $column_action; ?></td>
            </tr>
          </thead>
          <tbody>
            <?php if (isset($gallerys) && $gallerys): ?>
                <?php foreach ($gallerys as $gallery): ?>
                <tr>
                  <td style="text-align: center;"><?php if ($gallery['selected']) { ?>
                    ...
                    <?php } ?></td>
                  <td class="left"> <?php echo $gallery['app_name'];?></td>
                  <td class="left">
                    <?php if(isset($gallery['gallery_image']) && $gallery['gallery_image']):?>
        		  		<img src="<?php echo HTTP_IMAGE_GALLERY_SMALL . $gallery['gallery_image']?>"
        		  		 	 alt="Image App" height="42" width="42"> 
    		  		<?php endif;?>
    		  	  </td>
                 
                  <td class="right">
                  	[ <a href="<?php echo $gallery['action']; ?>">Edit</a> ]
                  </td>
                </tr>

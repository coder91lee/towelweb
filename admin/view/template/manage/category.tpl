            ...
            <?php if (isset($cates) && $cates): ?>
                ...
                <tr>
                  <td style="text-align: center;"><?php if ($cate['selected']) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $cate['category_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $cate['category_id']; ?>" />
                    <?php } ?></td>
                  <td class="left"><?php echo $cate['category_name']; ?></td>
                  <td class="left"><?php echo $cate['category_code']; ?></td>
                  <td class="left">
                    <?php if(isset($cate['category_image']) && $cate['category_image']):?>
        		  		<img src="<?php echo HTTP_IMAGE_CATEGORY_SMALL . $cate['category_image']?>"

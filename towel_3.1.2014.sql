...
CREATE DATABASE IF NOT EXISTS towel;
USE towel;
...
--
-- Definition of table `affiliate_transaction`
--
...
--
-- Definition of table `attribute_group`
--
...
--
-- Definition of table `attribute_group_description`
--
...
--
-- Definition of table `banner_image`
--
...
--
-- Definition of table `banner_image_description`
--
...
--
-- Definition of table `category_description`
--
...
--
-- Definition of table `category_filter`
--
...
--
-- Definition of table `category_path`
--
...
--
-- Definition of table `category_to_layout`
--
...
--
-- Definition of table `category_to_store`
--
...
--
-- Definition of table `coupon_category`
--
...
--
-- Definition of table `coupon_history`
--
...
--
-- Definition of table `coupon_product`
--
...
INSERT INTO `currency` (`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) VALUES 
 (1,'Pound Sterling','GBP','£','','2',0.60710001,1,'2014-01-02 21:35:45'),
 (2,'US Dollar','USD','$','','2',1.00000000,1,'2014-01-02 22:05:41'),
 (3,'Euro','EUR','','€','2',0.73240000,1,'2014-01-02 21:35:45');
...
--
-- Definition of table `custom_field_description`
--
...
--
-- Definition of table `custom_field_to_customer_group`
--
...
--
-- Definition of table `custom_field_value`
--
...
--
-- Definition of table `custom_field_value_description`
--
...
--
-- Definition of table `customer_ban_ip`
--
...
--
-- Definition of table `customer_field`
--
...
--
-- Definition of table `customer_group`
--
...
--
-- Definition of table `customer_group_description`
--
...
--
-- Definition of table `customer_history`
--
...
--
-- Definition of table `customer_ip`
--
...
--
-- Definition of table `customer_online`
--
...
--
-- Definition of table `customer_reward`
--
...
--
-- Definition of table `download_description`
--
...
--
-- Definition of table `filter_description`
--
...
--
-- Definition of table `filter_group`
--
...
--
-- Definition of table `filter_group_description`
--
...
CREATE TABLE `home_image` (
  `home_image_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `image` varchar(200) DEFAULT NULL,
  `status` tinyint(3) unsigned DEFAULT NULL,
  `link` varchar(200) DEFAULT NULL,
  `name` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`home_image_id`)
...
INSERT INTO `home_image` (`home_image_id`,`image`,`status`,`link`,`name`) VALUES 
 (1,'header.png',NULL,'','PRICE COMPETITIVE'),
 (2,'header.png',NULL,'','QUALITY ASSURED'),
 (3,'header.png',NULL,'','DELIVERY STABLE'),
 (4,'header.png',NULL,'','ORDER FLEXIBLE'),
 (5,'header.png',NULL,'','SERVICE PROFESSIONAL');
...
--
-- Definition of table `information_description`
--
...
--
-- Definition of table `information_to_layout`
--
...
--
-- Definition of table `information_to_store`
--
...
--
-- Definition of table `layout_route`
--
...
--
-- Definition of table `length_class`
--
...
--
-- Definition of table `length_class_description`
--
...
--
-- Definition of table `manufacturer_to_store`
--
...
INSERT INTO `module` (`module_id`,`name`,`code`) VALUES 
 (1,'Home Image','home_image'),
 (2,'Thông tin Trang','towel_info'),
 (3,'Chi tiết chuyên mục khăn','towel_cate_detail'),
 (4,'Towel Cate','towel_cate'),
 (5,'Box Contact','box_contact'),
 (6,'Towel Contact','towel_contact'),
 (7,'Chi tiết khăn','towel_detail');
/*!40000 ALTER TABLE `module` ENABLE KEYS */;


--
-- Definition of table `module_in_layout`
--

DROP TABLE IF EXISTS `module_in_layout`;
CREATE TABLE `module_in_layout` (
  `module_in_layout_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `module_id` int(10) unsigned DEFAULT NULL,
  `layout_id` int(10) unsigned DEFAULT NULL,
  `sort_order` int(10) unsigned DEFAULT NULL,
  `layout_pos` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`module_in_layout_id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `module_in_layout`
--

/*!40000 ALTER TABLE `module_in_layout` DISABLE KEYS */;
INSERT INTO `module_in_layout` (`module_in_layout_id`,`module_id`,`layout_id`,`sort_order`,`layout_pos`) VALUES 
 (2,1,1,1,1),
 (3,2,1,2,1),
 (10,1,12,1,1),
 (11,3,12,1,2),
 ...
 (23,4,14,1,5),
 (24,5,14,2,5);
/*!40000 ALTER TABLE `module_in_layout` ENABLE KEYS */;
...
--
-- Definition of table `option_description`
--
...
--
-- Definition of table `option_value`
--
...
--
-- Definition of table `option_value_description`
--
...
--
-- Definition of table `order_download`
--
...
--
-- Definition of table `order_field`
--
...
--
-- Definition of table `order_fraud`
--
...
--
-- Definition of table `order_history`
--
...
--
-- Definition of table `order_option`
--
...
--
-- Definition of table `order_recurring`
--
...
--
-- Definition of table `order_recurring_transaction`
--
...
--
-- Definition of table `order_total`
--
...
--
-- Definition of table `order_voucher`
--
...
--
-- Definition of table `product_attribute`
--
...
--
-- Definition of table `product_description`
--
...
--
-- Definition of table `product_discount`
--
...
--
-- Definition of table `product_filter`
--
...
--
-- Definition of table `product_option`
--
...
--
-- Definition of table `product_option_value`
--
...
--
-- Definition of table `product_profile`
--
...
--
-- Definition of table `product_recurring`
--
...
--
-- Definition of table `product_related`
--
...
--
-- Definition of table `product_reward`
--
...
--
-- Definition of table `product_special`
--
...
--
-- Definition of table `product_to_category`
--
...
--
-- Definition of table `product_to_download`
--
...
--
-- Definition of table `product_to_layout`
--
...
--
-- Definition of table `product_to_store`
--
...
--
-- Definition of table `profile_description`
--
...
/*!40000 ALTER TABLE `profile_description` DISABLE KEYS */;
/*!40000 ALTER TABLE `profile_description` ENABLE KEYS */;
...
--
-- Definition of table `return_action`
--
...
--
-- Definition of table `return_history`
--
...
--
-- Definition of table `return_reason`
--
...
--
-- Definition of table `return_status`
--
...
INSERT INTO `setting` (`setting_id`,`store_id`,`group`,`key`,`value`,`serialized`) VALUES 
 ...
 (133,0,'config','config_encryption','dc84469a17b5fe4c94328a42e2d45765',0),
 ...
 (131,0,'config','config_email','havietduc91@gmail.com',0),
 ...
 (132,0,'config','config_url','http://towelweb.local/',0);
/*!40000 ALTER TABLE `setting` ENABLE KEYS */;


--
-- Definition of table `stock_status`
--
...
--
-- Definition of table `tax_rate_to_customer_group`
--
...
--
-- Definition of table `towel`
--

DROP TABLE IF EXISTS `towel`;
CREATE TABLE `towel` (
  `towel_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `towel_name` varchar(100) DEFAULT NULL,
  `towel_image` varchar(200) DEFAULT NULL,
  `overview` text,
  `specification` text,
  `delivery` text,
  `status` tinyint(3) unsigned DEFAULT NULL,
  `price` varchar(45) DEFAULT NULL,
  `price_status` tinyint(3) unsigned DEFAULT NULL,
  `towel_cate_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`towel_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `towel`
--

/*!40000 ALTER TABLE `towel` DISABLE KEYS */;
INSERT INTO `towel` (`towel_id`,`towel_name`,`towel_image`,`overview`,`specification`,`delivery`,`status`,`price`,`price_status`,`towel_cate_id`) VALUES 
 (1,'Bath Towel 3*4','pic6.jpg','&lt;p&gt;&amp;nbsp;&amp;nbsp;&amp;nbsp; Lightweight, super absorbent and quick drying&lt;br /&gt;\r\n&amp;nbsp;&amp;nbsp;&amp;nbsp; Very soft, tender and comfortable&lt;br /&gt;\r\n&amp;nbsp;&amp;nbsp;&amp;nbsp; Wash and twist by hand or by washing machine&lt;/p&gt;\r\n','&lt;p&gt;Dimension: 65x130cm; 75x135cm; 100x160cm; etc.&lt;br /&gt;\r\nWeight: 3,000gram/dz; 3,750gram/dz; 4,500gram/dz; etc.&lt;br /&gt;\r\nMaterial: yarn OE20/1; CD20/2 20 % cotton&lt;br /&gt;\r\nColor: white and be customized&lt;/p&gt;\r\n','&lt;p&gt;&amp;nbsp;&amp;nbsp; Reference Price*: USD 6.3/kg CFR Haiphong Vietnam&lt;br /&gt;\r\n&amp;nbsp;&amp;nbsp;&amp;nbsp; Payment term: Irrevocable L/C at sight; TTr&lt;br /&gt;\r\n&amp;nbsp;&amp;nbsp;&amp;nbsp; Packaging: As buyer’s requirement&lt;br /&gt;\r\n&amp;nbsp;&amp;nbsp;&amp;nbsp; Delivery: 40 days after receipt of L/C&lt;br /&gt;\r\n&amp;nbsp;&amp;nbsp;&amp;nbsp; Capacity: 50 tons&amp;nbsp; per month&lt;/p&gt;\r\n\r\n&lt;p&gt;* Note: For detail price and quotation, please kindly contact us&lt;/p&gt;\r\n',1,'Free',1,1);
/*!40000 ALTER TABLE `towel` ENABLE KEYS */;


--
-- Definition of table `towel_cate`
--

DROP TABLE IF EXISTS `towel_cate`;
CREATE TABLE `towel_cate` (
  `towel_cate_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `towel_cate_name` varchar(100) DEFAULT NULL,
  `towel_cate_image` varchar(200) DEFAULT NULL,
  `status` tinyint(3) unsigned DEFAULT NULL,
  PRIMARY KEY (`towel_cate_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `towel_cate`
--

/*!40000 ALTER TABLE `towel_cate` DISABLE KEYS */;
INSERT INTO `towel_cate` (`towel_cate_id`,`towel_cate_name`,`towel_cate_image`,`status`) VALUES 
 (1,'Bath Towel','34x80g dz675g.JPG',1),
 (2,'Face Towel','PA050001.JPG',1),
 (3,'Oshibori Towel','pic10.jpg',1),
 (4,'Wipe Towel','purple 30x37 dz300g.JPG',1),
 (5,'Duster Towel','30x36 dz525g.JPG',1);
/*!40000 ALTER TABLE `towel_cate` ENABLE KEYS */;


--
-- Definition of table `towel_feedback`
--

DROP TABLE IF EXISTS `towel_feedback`;
CREATE TABLE `towel_feedback` (
  `towel_feedback_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT NULL,
  `email` varchar(100) DEFAULT NULL,
  `content` text,
  `creat_date` int(10) unsigned DEFAULT NULL,
  `status` tinyint(3) unsigned DEFAULT NULL,
  PRIMARY KEY (`towel_feedback_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `towel_feedback`
--

/*!40000 ALTER TABLE `towel_feedback` DISABLE KEYS */;
INSERT INTO `towel_feedback` (`towel_feedback_id`,`name`,`email`,`content`,`creat_date`,`status`) VALUES 
 (1,'dadsa','kaka@gmail.com','&lt;p&gt;dsadsa&lt;/p&gt;\r\n',1386869217,1),
 (2,'sdadsadsaddsad','','dsadsa',1387816973,0),
 (3,'sdadsadsaddsad','','dsadsad',1387816988,0),
 (4,'sdadsadsaddsad','','dsadsad',1387817030,0),
 (5,'sdadsadsaddsad','','dsadsad',1387817035,0),
 (6,'sdadsadsaddsad','','dsadsad',1387817038,0),
 (7,'adsadsasda','sdadsadsa','sấdd',1387817053,0),
 (8,'dsadsa','dsadsadsa','adsasdada',1387817134,0);
/*!40000 ALTER TABLE `towel_feedback` ENABLE KEYS */;


--
-- Definition of table `towel_image`
--

DROP TABLE IF EXISTS `towel_image`;
CREATE TABLE `towel_image` (
  `towel_image_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `image` varchar(200) DEFAULT NULL,
  `status` text,
  `towel_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`towel_image_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `towel_image`
--

/*!40000 ALTER TABLE `towel_image` DISABLE KEYS */;
INSERT INTO `towel_image` (`towel_image_id`,`image`,`status`,`towel_id`) VALUES 
 (3,'30x36 dz525g.JPG',NULL,1),
 (4,'34x80g dz675g.JPG',NULL,1),
 (5,'pic10.jpg',NULL,1);
/*!40000 ALTER TABLE `towel_image` ENABLE KEYS */;


--
-- Definition of table `url_alias`
--
...
INSERT INTO `user` (`user_id`,`user_group_id`,`username`,`password`,`salt`,`firstname`,`lastname`,`email`,`code`,`ip`,`status`,`date_added`) VALUES 
 (1,1,'admin','996e478b8b0cdd8fcb3f18ebb287fa8893759f18','d109e961c','','','havietduc91@gmail.com','','127.0.0.1',1,'2013-12-10 23:40:23');
...
--
-- Definition of table `voucher_history`
--
...
--
-- Definition of table `voucher_theme`
--
...
--
-- Definition of table `voucher_theme_description`
--
...
--
-- Definition of table `weight_class`
--
...
--
-- Definition of table `weight_class_description`
--
...
--
-- Definition of table `zone_to_geo_zone`
--
